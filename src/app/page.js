  ...
  return (
    <div style={{ background: 'var(--paper)', minHeight: '100vh' }}>
      ...
      <section className="mk-hero">
        <div>
          ...
          <div className="mh-note">
            <span className="dot" />
            No credit card · free forever · 40+ cities mapped
          </div>
        </div>
          ...
          {[
            {
              ...
              desc: 'Tell us a city and your interests. Our AI surfaces ~20 hidden gems and scores each one for hiddenness — streaming them in live as it discovers them.',
      ...
      <section className="mk-section bordered">
        <div className="proof">
          <div className="pstat"><div className="pn">40+</div><div className="pl">Cities covered</div></div>
          <div className="pstat"><div className="pn">8,200</div><div className="pl">Spots scored</div></div>
          <div className="pstat"><div className="pn">100%</div><div className="pl">Geocoded pins</div></div>
        </div>
      </section>
